...
class TestTrading(object):
    ...
    def test_get_mng_transaction_detail(self):
        r = self.mygrpc.get_mng_transaction_detail()
        print(r)

    def test_get_mng_transaction_list(self):
        r = self.mygrpc.get_mng_transaction_list()
        print(r)
    ...
    def test_get_transaction_list(self):
        r = self.mygrpc.get_transaction_list()
        print(r)
    ...
    def test_update_mng_transaction_status(self):
        r = self.mygrpc.update_mng_transaction_status()
        print(r)
    ...
    def test_user_transaction(self):
        r = self.mygrpc.user_transaction()
        print(r)
